...
data class ItemGeneratorFuel(override val burnTime: Int, var currentBurnTime: Int, override val energyOutput: Double) : GeneratorFuel {
    ...
    companion object {
        ...
        fun fromTag(tag: NbtCompound): ItemGeneratorFuel? {
            ...
            return if(energyOutput == 0.0) null else ItemGeneratorFuel(burnTime, currentBurnTime, energyOutput)
        }

        fun fromBuf(buf: PacketByteBuf): ItemGeneratorFuel? {
        ...
        fun fromJson(jsonObject: JsonObject): ItemGeneratorFuel? {
            val burnTime = jsonObject.get("burnTime").asInt
            val energyOutput = jsonObject.get("energyOutput").asDouble
            return if (energyOutput == 0.0) null else ItemGeneratorFuel(burnTime, energyOutput)
        }

        fun fromItemResource(id: String, itemStack: ItemStack): ItemGeneratorFuel? {
        ...
        fun fromGluttonyGeneratorFuel(item: Item): ItemGeneratorFuel? {
            ...
            return ItemGeneratorFuel(round(burnTime).toInt(), round(energyOutput))
        }

        fun fromEnchantedGeneratorFuel(itemStack: ItemStack): ItemGeneratorFuel? {
        ...
        fun fromBrewGeneratorFuel(itemStack: ItemStack): ItemGeneratorFuel? {
